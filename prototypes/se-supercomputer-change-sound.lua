...
for _, prototype in pairs(data.raw["assembling-machine"]) do
    ...
    if proto_name and proto_name == "se-space-supercomputer" then --assembling-machine for tests
        ...
        fssm.applyNewSound(prototype, work_sound, settings.startup["RWsss_volume"].value)
    end
end
